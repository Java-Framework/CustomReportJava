...
public class HTMLReporter extends TestListenerAdapter implements IReporter
{
    ...
    private void startHtmlPage(PrintWriter out)
    {
        ...
        out.println("<head>");
        out.println("<title>Freshservice QA Automation Report</title>");
        out.println("</head>");
        out.println("<body><div style=\"margin:0 auto; padding:15px; min-height:450px; min-width: 450px; height:auto;\">"
                ...
                + "<h1 style=\"background-color: #93b874; color: white; text-align: center; font-family: Georgia;\">Freshservice QA Automation Report</h1>");
    ...
    {
        out.println("<br/><br/><div align=\"right\"> &copy; <a href=\"http://www.freshdesk.com\">2016 Freshdesk Inc.</a></div>");
